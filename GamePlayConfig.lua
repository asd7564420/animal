...
GamePlayConfigScore.CanevineBomb = 500
...
GamePlayConfigScore.BonusStepScores = {
	[1] = 5000,
	[2] = 6000,
	[3] = 7000,
	[4] = 8000,
...
GamePlayConfigScore.Gyro = 100
GamePlayConfigScore.TravelEnergyBag = 100
GamePlayConfigScore.WalkChick = 10000
GamePlayConfigScore.ChannelTarget = 1000

GamePlayConfigScore.CuckooWindupKey = 10
GamePlayConfigScore.CuckooBirdReachEnd = 10000

GamePlayConfigScore.ShellGift = 100
GamePlayConfigScore.AddStepAnimal = 100

GamePlayConfigScore.Firework = 100
GamePlayConfigScore.Battery = 100
...
GamePlayConfig_Top_Height = 211 + 100				-- 棋盘上方留白的距离！根据资源和产品要求调整，不能随便修改！
GamePlayConfig_Bottom_Height = 160 + 50 			-- 期盼下方留白的距离！根据资源和产品要求调整，不能随便修改！
...
function setDefaultGamePLayGlobalParameter()
	...
	GamePlayConfig_Hammer_Animation_CD = 35 * GamePlayConfig_Action_FPS_Time_Scale 			-- 锤子的动画播放时间
	...
	--
	GamePlayConfig_LineBrush_Animation_CD = 70 * GamePlayConfig_Action_FPS_Time_Scale		    -- 条纹刷子的等待动画播放时间（此时间过后目标的类型即被转换）
	--使用道具后播放星星动画的数据
	GamePlayConfig_LineBrush_EFFECT_CD = 50 * GamePlayConfig_Action_FPS_Time_Scale
	...
	GamePlayConfig_Score_MatchDeleted_Scale_SUPER_BIG = 1.75 													----分数字大小
	GamePlayConfig_Score_MatchDeleted_Scale_BIG = 1.25 													----分数字大小
	GamePlayConfig_Score_MatchDeleted_Scale_NORMAL = 1 												----分数字大小
	GamePlayConfig_Score_MatchDeleted_Scale_SMALL = 0.85												----分数字大小
    ...
    GamePlayConfig_GameItemCanevineOpenFlower_CD = 10
