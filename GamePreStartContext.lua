...
function GamePreStartContext:initBagInfo()
	...
	UserService:getInstance():getAndUpdateTimeProps()
...
function GamePreStartContext:getPlayIdIfExist( ... )
	if _instance and _instance.playId then
		return _instance.playId
	end
end