GameItemType = table.const
{
    ...
    kGyro = 67, --陀螺
    kGyroCreater = 68, --陀螺生成器
    kWater = 69,
    kWindTunnelSwitch = 70,

    kActivityCollectionItem = 71, --感恩收集物

    kTravelHero = 72,					--旅行模式：主人公
    kTravelEnergyBag = 73,				--旅行模式：能量包
    kTravelFinishBuilding = 74,			--旅行模式：终点建筑
    kTravelFinishBuildingEmpty = 75,	--旅行模式：终点建筑占位
    kTravelEventBox = 76,				--旅行模式：礼盒

	kCanevine = 77,
	kPlane = 78,		--飞机

	kWeeklyRace2020Chest = 79,		--新周赛终点宝箱
	kWeeklyRace2020JewelChest = 80,	--新周赛宝石宝箱

	kCattery = 81,  --猫窝
	kCatteryEmpty = 82, --猫窝占位
	kMeow = 83,	    --喵喵

	kAngryBird = 84, --愤怒的小鸟
	kDynamiteCrate = 85, --愤怒的炸药箱（效果相当于只有1级的冰封导弹）
	kSling = 86,

	kTreasureFish = 87, --按图索骥亲吻鱼
	kWalkChick = 88,--过河拆桥的鸡
	kWalkChickEnd = 89,--过河拆桥终点
	kSlyBunnyLane = 90, --消除节：狡兔三窟的草坪
	kChannelTarget = 91,--水到渠成 目标

	kCuckooBird = 92,				-- 布谷鸟
    kCuckooClock = 93,				-- 布谷鸟的钟
	kCuckooWindupKey = 94,			-- 布谷鸟的发条钥匙
    ...
    kNationalDayBunny = 98,    --国庆兔子

    kNDBunnySnow = 99,         --国庆兔子萝卜
...
GamePropsType = table.const
{
    ...
    kSpringSkill1 = 99979, --春节技能 
    kSpringSkill2 = 99979, --春节技能 
    kSpringSkill3 = 99979, --春节技能 
    kSpringSkill4 = 99979, --春节技能 

    kGetTempProp = 99970,
    kCastBird = 99989,
    
    -- 每个技能有4级，80 - 92已使用
    kRailRoad1 = 99980, --暑期技能 1
    kRailRoad2 = 99984, --暑期技能 2
    kRailRoad3 = 99988, --暑期技能 3
    kRailRoadEnd = 99992, --暑期技能最后一级

    kSnowMonster = 10136, --雪怪道具，第五步炸弹
    kAdd5TravelMode = 10139,
    kAdd5Valentine2020 = 10142,

	KSixyear_add5 = 10145,		--六周年+5步		
    kSixyear_add2 = 10146,		--六周年+2步	

    kAdd5Sakura2020 = 10147, --樱花活动+5步
    kAdd5WeeklyRace2020 = 10148,	--2020新周赛+5步
    kAdd5AngryBirds = 10158,		--愤鸟联动+5步
    kAdd2AngryBirds = 10159,		--愤鸟联动+2步

    kAdd10Autumn2020 = 51254,      --中秋加十步

	kAdd15Autumn2020 = 51255, 		--中秋加十五步


    -- 一定要按顺序 往后加。别在窜了
    kAdd2_b = 98000,				-- 游戏前置 +2 6周年假道具 
    kWeeklyRace2020SPProp = 98001,  -- 2020新周赛道具大招
}
...
GamePlayGlobalParams = {
	KNewCrystalLogicMainLevel = 2821,
	KNewCrystalLogicHiddenLevel = 10562,
	KNewCrystalLogicActLevel = 370000,
}