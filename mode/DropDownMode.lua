...
function DropDownMode:saveDataForRevert(saveRevertData)
  ...
  saveRevertData.ingredientsShouldCome = mainLogic.ingredientsShouldCome
...
function DropDownMode:revertDataFromBackProp()
  ...
  mainLogic.ingredientsShouldCome = mainLogic.saveRevertData.ingredientsShouldCome or false
