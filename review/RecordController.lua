...
function RecordController:startRecord()
	...
	local function doBeforeStartRecord()
	...
	elseif __ANDROID then
	  ...
	  --   PermissionManager.getInstance():requestEach(PermissionsConfig.WRITE_EXTERNAL_STORAGE, doScreenRecord, function ()
			-- if self.state == RecordController.STATE.kRequestingStart then
   --      		self:afterStartFail()
   --      	else
   --      		self:afterStopSuccess()
