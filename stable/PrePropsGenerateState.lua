...
function PrePropsGenerateState:onEnter()
    ...
    elseif GameInitBuffLogic:hasBuffOfTypeInLevel(InitBuffType.FIRECRACKER, {InitBuffCreateType.PRE_PROP, InitBuffCreateType.REMIND_PRE_PROP, InitBuffCreateType.WINNINGSTREAK_BUFF_ACTIVITY}) then    -- 由后续每轮生成
