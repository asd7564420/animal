...
function FurballSplitState:handleFurballSplitComplete()
	...
	if self.counterFurballSplitToHandle >= self.totalFurballSplitToHandle then
		TravelLogic:removeBlockStateType(self.mainLogic, TravelWalkStateBlockType.kBrownCuteBall)
		CuckooLogic:removeBlockStateType(self.mainLogic, CuckooBirdWalkStateBlockType.kBrownCuteBall)
