	...
	for k, v in pairs(seaAnimals) do
		...
		if v.isFreed ~= true then
			...
			if isFreed then
                ...
                elseif v.type == SeaAnimalType.kPopcorn_32 then
                	key2 = 	GameItemOrderType_SeaAnimal.kPopcorn_32
                	rotation = 0
                	addScore = 1000
                elseif v.type == SeaAnimalType.kPopcorn_23 then
                	key2 = 	GameItemOrderType_SeaAnimal.kPopcorn_23
                	rotation = -90
                	addScore = 1000
				end
