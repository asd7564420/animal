...
function GameOverState:onEnter()
	if _G.isLocalDevelopMode then printx(0, "GameOverState---->>>> game over state enter") end
...
function GameOverState:onExit()
	if _G.isLocalDevelopMode then printx(0, "GameOverState----<<<< game over state exit") end

	require "zoo.util.GameSpeedButton"
	GameSpeedButton.clear()
